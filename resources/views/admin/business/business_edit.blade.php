            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Edit Business Page</h4>
                        <br></br>
                       
                        <form id="myForm" method="POST" action="{{ route('business.update') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input class="form-control" type="text" name="phone_number" value="{{ $business->phone_number }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="showLogoImage" class="rounded avatar-lg" src="{{ $business->logo_image ? asset($business->logo_image) : url('upload/no_image.jpg') }}" class="card-img-top">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label"></label>
                                <div class="col-sm-10">
                                    <img id="showCoverImage" class="rounded avatar-lg" src="{{ $business->cover_image ? asset($business->cover_image) : url('upload/no_image.jpg') }}" class="card-img-top">
                                </div>
                            </div>

                            <center>
                                <input type="submit" class="btn btn-info waves-effect waves-light" value="Update Business">
                            </center>
                        </form>
