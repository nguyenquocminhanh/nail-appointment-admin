                        ...
                        <form id="myForm" method="POST" action="{{ route('staff.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input class="form-control" type="text" name="username" value="{{ $staff->username }}">
                                        @error('username')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input class="form-control" type="text" name="phone_number" value="{{ $staff->phone_number }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="col-sm-10">
                                                <img id="showImage" class="rounded avatar-lg" src="{{ $staff->profile_image ? asset($staff->profile_image) : url('upload/no_image.jpg') }}" class="card-img-top">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <p class="checkbox">
                                            ...
                                            document.getElementsByName('service_id[]').item(c).checked=this.checked"
                                            > Select All
                                        </p>
                                        <hr>
                                        ...
                                        <p class="checkbox">
                                            ...
                                            @if(isset($services_user)){{$services_user->contains('id', $service->id) ? 'checked' : ''}} @endif
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        @if($staff_days->contains('day_of_week', $day))
                                        <div class="row checkbox"> 
                                            <div class="col-md-3 d-sm-flex align-items-center">
                                                <input type="checkbox" name="day[]" value="{{ $key }}"
                                                checked
                                                class="day-checkbox">&nbsp; {{ $day }}
                                            </div>
                        
                                            <div class="col-md-9">
                                                From: &nbsp;
                                                @php
                                                    $staff_day = App\Models\StaffDay::where('user_id', $staff->id)->where('day_of_week', $day)->first();
                                                @endphp
                                                <input name="from_time[]" class="time-picker" type="time" value="{{ date('H:i', strtotime($staff_day->from_time)) }}">
                                                &nbsp; &nbsp; &nbsp;
                                                To: &nbsp;
                                                <input name="to_time[]" class="time-picker" type="time" value="{{ date('H:i', strtotime($staff_day->to_time)) }}">
                                            </div>  
                                        </div>
                                        @else
                                        <div class="row checkbox"> 
                                            ...
                                            <div class="col-md-9">
                                                From: &nbsp; 
                                                <input name="from_time[]" class="time-picker" type="time">
                                                &nbsp; &nbsp; &nbsp;
                                                To: &nbsp; 
                                                <input name="to_time[]" class="time-picker" type="time">
                                            </div>   
                                        </div>
                                        @endif
                                        @endforeach
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input type="checkbox" @if($staff->visible == '1') checked @endif name="visible" value="1">
                                        When enabled, this staff member will appear in your Booking Site.
                                    </div>
                                </div>
                            </div>
                            ...
                            <center>
                                <input type="submit" class="btn btn-info waves-effect waves-light" value="Update Staff Member">
                            </center>
                        </form>
